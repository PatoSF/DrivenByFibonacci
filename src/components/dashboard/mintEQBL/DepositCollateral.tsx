...
import useDepositCollateral from "@/hooks/equilibrium/useDepositCollateral";
...
const DepositCollateral = () => {
  ...
  const handleDepositAndMint = useDepositCollateral();

  const handleMint = async () => {
    await handleDepositAndMint(selectedToken!, Number(colAmount));
  };
