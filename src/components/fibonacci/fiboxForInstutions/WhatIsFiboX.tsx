...
const WhatIsFiboX = () => {
    return (
        <section className="w-full pb-28 bg-color1 px-4">
            <main className="max-w-6xl mx-auto bg-color2 rounded-2xl lg:p-10 p-4">
                <div className="flex md:flex-row flex-col md:justify-between lg:gap-0 gap-6">
                    <h1 className="max-w-sm text-color1 md:text-5xl text-4xl font-inter font-bold">What is Institutional FIBO?</h1>
