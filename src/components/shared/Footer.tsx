        ...
        <footer className="bg-color2 pt-20 pb-14">
            <div className="max-w-7xl mx-auto px-4 lg:px-10">
                ...
                <div className="container grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
                    {NavLinks.filter((link) => link.name !== "Transparency").map((link) => (
                ...
                <div className="mt-20 flex flex-col justify-center items-center text-center">
                    <Logo classname="lg:w-[100px] w-[50px]" image="/fibo-logo.png" href="/" />
                    <p className="mt-4 text-gray-300 font-nunitoSans text-sm">Driven by Fibonacci</p>
                    <p className="mt-2 text-gray-300 font-nunitoSans text-xs">
                        &copy; {year} Driven by Fibonacci. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
