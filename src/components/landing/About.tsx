    ...
    return (
        <section className="w-full lg:h-screen h-auto grid md:grid-cols-2 bg-color2">
            ...
            <main className="flex flex-col py-16 lg:py-0 justify-center items-start gap-4 px-4 md:px-8 lg:px-10">
                ...
                <p className='lg:text-lg text-base font-nunitoSans text-color1/90'>EulerFi is built on the timeless principles of mathematical harmony, transforming patterns into actionable insights. 
                By leveraging the power of asset allocation and risk management, we create a seamless flow where structure meets adaptability, ensuring stability even in dynamic environments. 
                Every calculation is a step toward precision, every trend a reflection of natural order—unveiling opportunities with unwavering consistency.</p>

                <Button variant={'outline'} className="bg-color2 border-color5 text-color5 transition-all duration-200 hover:bg-color5 hover:text-color1">Learn More</Button>
            </main>
        </section>
    )
}
